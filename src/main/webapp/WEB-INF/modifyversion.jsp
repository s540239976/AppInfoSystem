    ...
    <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show" style="text-align: center;margin-top: 50px;margin-left: 200px">
                ...
                <h2>修改版本信息</h2>
                <form class="layui-form" enctype="multipart/form-data" method="post" action="version/modifyVersionSave?id=${versionList[0].id}" style="margin-left: 450px">
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                            <span class="x-red">*</span>版本号
                        </label>
                        <div class="layui-input-inline">
                            <input type="text" name="versionNo" value="${versionList[0].versionNo}" readonly
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="versionSize" value="${versionList[0].versionSize}"
                                   autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <textarea name="versionInfo">${versionList[0].versionInfo}</textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">
